...
#endif
    static pcl::PointCloud<pcl::PointXYZINormal>::Ptr pointCloud2ToPCL(
        const sensor_msgs::msg::PointCloud2 &msg, int filter_num, double min_range = 0.5, double max_range = 20.0);
